...
const features = [
  {
    ...
    description: 'Quality financial education made accessible for all.',
  },
  {
    image: '/images/wbs-left-img.png',
    icon: '/images/wbs-right-part.png',
    title: 'Interactive Tools',
    description: 'Engage with real-time simulations and data.',
  },
  {
    image: '/images/wbs-left-img.png',
    icon: '/images/wbs-right-part.png',
    title: 'Gamified Learning',
    description: 'Earn rewards as you progress through content.',
  },
  {
    image: '/images/wbs-left-img.png',
    icon: '/images/wbs-right-part.png',
    title: 'Expert Support',
    description: 'Get guidance from professionals anytime.',
  },
  {
    image: '/images/wbs-left-img.png',
    icon: '/images/wbs-right-part.png',
    title: 'Progress Tracking',
    description: 'Stay motivated with visible milestones.',
  },
];

const WhyBestSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full bg-[#0D130E] text-white overflow-hidden px-[40px] md:px-[80px] py-[60px] md:py-[120px] rounded-[60px] -mt-[45px] sm:-mt-[50px] md:-mt-[50px] lg:-mt-[100px] z-10">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-gray-400 max-w-[90%]">
            Dive into the stock market with hands-on activities that turn learning into a fun and rewarding journey.
            Learn, play, and grow with an educational experience crafted for modern investors.
          </p>
